...
# encoding: 'oh' - one hot encoding
def main(encoding='oh', subontology='mf', nb_epoch=15, gram_len=1, embedding_size=15, batch_size=64, run=1):
    ...
    model_path = 'models/bottleneck_' + encoding + '_' + subontology + '_e' + str(nb_epoch) \
